...
const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    description: 'StudyX merge pe nivelurile gratuite de la Groq, Google Gemini, Cerebras și Mistral AI — fără card, doar cu un cont. Când una atinge limita zilnică, aplicația trece automat pe următoarea și continuă de unde ai rămas. Cu toate patru salvate, practic nu mai rămâi blocat.',
    Demo: FreeKeysDemo,
