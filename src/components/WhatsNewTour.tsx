...
const SLIDES: Slide[] = [
  {
    ...
    title: 'StudyX v1.0.9 — AI-ul îți desenează, nu doar îți scrie',
  ...
  },
  {
    ...
    tip: 'Reimportă cărțile adăugate înainte de 1.0.9 ca să primească și ele capitolele.',
  },
  {
    id: 'grile-scan',
