// Development commands using npx instead of npm (CommonJS version)
...
Usage: node scripts/dev-commands.cjs <command>
...
💡 Examples:
  node scripts/dev-commands.cjs dev
  node scripts/dev-commands.cjs build
  node scripts/dev-commands.cjs test
  node scripts/dev-commands.cjs analyze:build

🎯 Quick Start:
  1. node scripts/dev-commands.cjs install-deps
  2. node scripts/dev-commands.cjs dev
